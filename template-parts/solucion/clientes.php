...
<section class="match-sol-clientes">
	<div class="match-sol-clientes__head">
	...
	<ul class="match-sol-clientes__grid">
		<?php foreach ( $args['clients'] as $slug ) : ?>
			<li><img src="<?php echo esc_url( get_theme_file_uri( "assets/img/logos/{$slug}.png" ) ); ?>" alt="<?php echo esc_attr( $logos[ $slug ] ?? $slug ); ?>" loading="lazy" decoding="async"></li>
		<?php endforeach; ?>
	</ul>
</section>
